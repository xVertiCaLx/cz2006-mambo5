...
public class CamsLoginForm extends JPanel {
	...
	public CamsLoginForm() {
		...
		JLabel canteenLbl = new JLabel("#Canteen");
		canteenLbl.setForeground(Color.WHITE);
		canteenLbl.setFont(new Font("Arial", Font.BOLD, 12));
		canteenLbl.setBounds(10, 0, 103, 39);
		panel.add(canteenLbl);
